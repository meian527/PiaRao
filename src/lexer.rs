...
impl<'a> Lexer<'a> {
    ...
    fn skip_whitespace(&mut self) {
        if self.pos < self.len && self.s[self.pos].is_ascii_whitespace() {
            ...
            match self.s[self.pos] {
                ...
                _ => {
                    if self.s[self.pos].is_ascii_digit() {
                        ...
                        while self.s[self.pos].is_ascii_alphanumeric()
                            || self.s[self.pos] == b'_'
                        ...
                        panic!(
                            ...
                            self.s[self.pos] as char, self.line, self.col
                        );
                    }
                }
            }
